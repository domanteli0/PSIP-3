...
\defineProcess{CICD}{AR}{Aplinkos rengimas}
...
\defineProcess{Requirements}{RV}{Reikalavimų valdymas}
\defineProcess{Control}{KO}{Kontrolė} % Čia gal review'iu???

 \defineProcess{ConfigAudit}{KAU}{Projekto konfigūracijos auditas}
