...
\describeWorkProd{ClientReq}{ \hladd{Kliento pusėje suprojektuoti reikalavimai projektui, kurie apibrėžia detales, kaip kliento poreikiai projektui (KP) turėtų būti išpildyti projekte. 
...
Tai programinės įrangos sukurtas instrukcijų rinkinys, kuris įgyvendina produkto užduočių sąraše (\workProdId{Backlog}) nurodytus reikalavimus. Programinis kodas apima ir  programininės įrangos kūrėjų parašytus modulių testus ir testuotojų sukurtus testus.
}
...
\describeWorkProd{Environment}{
        Infrastruktūra, kurioje vykdomas testavimas ir diegiamas programinis kodas, laikoma konfigūracija. \hladd{Dokumentuoti testavimo įrankiai. Dokumentuoti operaciniai scenarijai, aplinka, procedūros, įvestis ir išvestis, kuri tikrins realaus pasaulio sąlygas testavimo aplinkoje.
        }
}

\describeWorkProd{Risks}{
        Rizikų valdymo planas yra dokumentas, kuriame identifikuojamos, vertinamos ir aprašomos galimos projekto rizikos. Planas apima rizikų identifikavimo metodus, rizikų vertinimo kriterijus, rizikų prioritetų nustatymą bei rizikų mažinimo ir valdymo strategijas. Be to, jame nurodomos atsakomybės už rizikų valdymą, rizikų stebėjimo procedūros ir komunikacijos planas su suinteresuotomis šalimis.
}

\describeWorkProd{ConfigRepo}{
    \hladd{Čia laikomi produkto konfigūraciniai failai. Pagrindinė šios repozitorijos šaka atitinka bazinę produkto konfigūraciją.
    }
}

\describeWorkProd{CodeReviewReport}{
    \hladd{Kodo Peržiūros Raportas. Šiame dokumente renkama informacija apie pasiruošimą kodo peržiūrai, jos eigą ir rezultatus.}
}

\describeWorkProd{ISD}{\hladd{Šioje dokumentacijoje yra aprašyta visos aktualios išorinių sąsajų techninės detalės, kurių gali prireikti kuriant integracija su šiomis sąsajomis.}}

\describeWorkProd{StakeholderInterest}{

    \hladd{Čia aprašomas SŠ įsitraukimas, susįjusios problemos ir jų pasekmės ir galimi sprendimo būdai.}
